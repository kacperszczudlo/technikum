...
<head>
    ...
    <style>
        ...
        .wynik{border: solid 1px green;padding: 10px;margin: 30px 20px;}
        body {background-color: rgb(49, 49, 49);color: red;padding: 10px;;}
        h1 {background-color: rgb(49, 49, 49);padding: 20px;}
    </style>
</head>
<body>
<h1>Podaj swoje dane</h1>
    ...
    <?php
     ...
     if (isset($_POST['imie'])) {
       ...
       $errorhtml = "<div>Brak danych.</div>\n";
       if ($imie != null && $nazwisko != null && $data != null) {
         if (count($zaint) > 0) {
         ...
         echo "<div class='redwynik'>{$errorhtml}</div>";
       }
     }
     ?>
   </div>
